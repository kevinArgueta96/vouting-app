  ...
  return (
      ...
      <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 flex flex-col items-center justify-center h-full">
        <div className="bg-white/10 backdrop-blur-sm p-8 sm:p-10 md:p-12 rounded-2xl shadow-2xl w-full flex flex-col justify-between gap-8 sm:gap-6">
          <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold text-center text-white tracking-tight mb-8 sm:mb-8 break-words hyphens-auto">
            {t('title')}
          </h1>
          <p className="text-lg sm:text-xl md:text-2xl text-center text-gray-100 max-w-2xl mx-auto mb-12 sm:mb-12 break-words hyphens-auto leading-relaxed">
            {t('description')}
          </p>
          <div className="w-full max-w-md mx-auto mt-auto">
            <Button 
              size="lg" 
              className="w-full py-6 sm:py-7 text-lg sm:text-xl font-semibold bg-white text-vouting-blue hover:bg-gray-100 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl rounded-xl border-2 border-white/20" 
              asChild
            >
